...
synth_design -top S_box_layer -part xc7a50tcsg325-1 -max_dsp 0


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef S_box_layer.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file S_box_layer_utilization_synth.rpt -pb S_box_layer_utilization_synth.pb"
