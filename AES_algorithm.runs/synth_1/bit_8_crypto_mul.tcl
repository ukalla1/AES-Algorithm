...
read_verilog -library xil_defaultlib C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.srcs/sources_1/new/bit_8_crypto_mul.v
...
synth_design -top bit_8_crypto_mul -part xc7a50tcsg325-1 -max_dsp 0


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef bit_8_crypto_mul.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file bit_8_crypto_mul_utilization_synth.rpt -pb bit_8_crypto_mul_utilization_synth.pb"
