...
synth_design -top shift_rows -part xc7a50tcsg325-1 -max_dsp 0


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef shift_rows.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file shift_rows_utilization_synth.rpt -pb shift_rows_utilization_synth.pb"
