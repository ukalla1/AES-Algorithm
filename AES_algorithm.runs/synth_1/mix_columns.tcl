...
synth_design -top mix_columns -part xc7a50tcsg325-1 -max_dsp 0


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef mix_columns.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file mix_columns_utilization_synth.rpt -pb bit_32_crypto_mul_utilization_synth.pb"
