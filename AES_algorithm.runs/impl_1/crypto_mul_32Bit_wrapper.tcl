...
set rc [catch {
  ...
  add_files -quiet C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.runs/synth_1/crypto_mul_32Bit_wrapper.dcp
  read_xdc C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.srcs/constrs_1/new/tim.xdc
  link_design -top crypto_mul_32Bit_wrapper -part xc7a50tcsg325-1
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force crypto_mul_32Bit_wrapper_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file crypto_mul_32Bit_wrapper_drc_opted.rpt -pb bit_32_crypto_mul_drc_opted.pb -rpx bit_32_crypto_mul_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force crypto_mul_32Bit_wrapper_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file crypto_mul_32Bit_wrapper_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file crypto_mul_32Bit_wrapper_utilization_placed.rpt -pb bit_32_crypto_mul_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file crypto_mul_32Bit_wrapper_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force crypto_mul_32Bit_wrapper_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file crypto_mul_32Bit_wrapper_drc_routed.rpt -pb bit_32_crypto_mul_drc_routed.pb -rpx bit_32_crypto_mul_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file crypto_mul_32Bit_wrapper_methodology_drc_routed.rpt -pb bit_32_crypto_mul_methodology_drc_routed.pb -rpx bit_32_crypto_mul_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file crypto_mul_32Bit_wrapper_power_routed.rpt -pb bit_32_crypto_mul_power_summary_routed.pb -rpx bit_32_crypto_mul_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file crypto_mul_32Bit_wrapper_route_status.rpt -pb bit_32_crypto_mul_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file crypto_mul_32Bit_wrapper_timing_summary_routed.rpt -warn_on_violation  -rpx bit_32_crypto_mul_timing_summary_routed.rpx"
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file crypto_mul_32Bit_wrapper_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file crypto_mul_32Bit_wrapper_clock_utilization_routed.rpt"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force crypto_mul_32Bit_wrapper_routed_error.dcp
