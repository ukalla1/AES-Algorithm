...
set rc [catch {
  ...
  add_files -quiet C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.runs/synth_1/bit_8_crypto_mul.dcp
  read_xdc C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.srcs/constrs_1/new/tim.xdc
  link_design -top bit_8_crypto_mul -part xc7a50tcsg325-1
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force bit_8_crypto_mul_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file bit_8_crypto_mul_drc_opted.rpt -pb bit_8_crypto_mul_drc_opted.pb -rpx bit_8_crypto_mul_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force bit_8_crypto_mul_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file bit_8_crypto_mul_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file bit_8_crypto_mul_utilization_placed.rpt -pb bit_8_crypto_mul_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file bit_8_crypto_mul_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force bit_8_crypto_mul_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file bit_8_crypto_mul_drc_routed.rpt -pb bit_8_crypto_mul_drc_routed.pb -rpx bit_8_crypto_mul_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file bit_8_crypto_mul_methodology_drc_routed.rpt -pb bit_8_crypto_mul_methodology_drc_routed.pb -rpx bit_8_crypto_mul_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file bit_8_crypto_mul_power_routed.rpt -pb bit_8_crypto_mul_power_summary_routed.pb -rpx bit_8_crypto_mul_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file bit_8_crypto_mul_route_status.rpt -pb bit_8_crypto_mul_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file bit_8_crypto_mul_timing_summary_routed.rpt -warn_on_violation  -rpx bit_8_crypto_mul_timing_summary_routed.rpx"
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file bit_8_crypto_mul_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file bit_8_crypto_mul_clock_utilization_routed.rpt"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force bit_8_crypto_mul_routed_error.dcp
