...
synth_design -top S_box_wrapper -part xc7a200tfbg676-2 -max_dsp 0


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef S_box_wrapper.dcp
create_report "synth_2_synth_report_utilization_0" "report_utilization -file S_box_wrapper_utilization_synth.rpt -pb S_box_wrapper_utilization_synth.pb"
