...
set rc [catch {
  ...
  add_files -quiet C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.runs/synth_2/mix_columns.dcp
  read_xdc C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.srcs/constrs_1/new/tim.xdc
  link_design -top mix_columns -part xc7a200tfbg676-2
...
set rc [catch {
  ...
  create_report "impl_2_opt_report_drc_0" "report_drc -file mix_columns_drc_opted.rpt -pb mix_columns_drc_opted.pb -rpx mix_columns_drc_opted.rpx"
...
set rc [catch {
  ...
  create_report "impl_2_place_report_io_0" "report_io -file mix_columns_io_placed.rpt"
  create_report "impl_2_place_report_utilization_0" "report_utilization -file mix_columns_utilization_placed.rpt -pb mix_columns_utilization_placed.pb"
  create_report "impl_2_place_report_control_sets_0" "report_control_sets -verbose -file mix_columns_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_2_route_report_drc_0" "report_drc -file mix_columns_drc_routed.rpt -pb mix_columns_drc_routed.pb -rpx mix_columns_drc_routed.rpx"
  create_report "impl_2_route_report_methodology_0" "report_methodology -file mix_columns_methodology_drc_routed.rpt -pb mix_columns_methodology_drc_routed.pb -rpx mix_columns_methodology_drc_routed.rpx"
  create_report "impl_2_route_report_power_0" "report_power -file mix_columns_power_routed.rpt -pb mix_columns_power_summary_routed.pb -rpx mix_columns_power_routed.rpx"
  create_report "impl_2_route_report_route_status_0" "report_route_status -file mix_columns_route_status.rpt -pb mix_columns_route_status.pb"
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file mix_columns_timing_summary_routed.rpt -warn_on_violation  -rpx mix_columns_timing_summary_routed.rpx"
  create_report "impl_2_route_report_incremental_reuse_0" "report_incremental_reuse -file mix_columns_incremental_reuse_routed.rpt"
  create_report "impl_2_route_report_clock_utilization_0" "report_clock_utilization -file mix_columns_clock_utilization_routed.rpt"
