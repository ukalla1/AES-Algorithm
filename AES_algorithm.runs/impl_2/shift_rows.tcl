...
set rc [catch {
  ...
  add_files -quiet C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.runs/synth_2/shift_rows.dcp
  read_xdc C:/Users/uttej/Desktop/VivadoProjs/learn_hw/AES_algorithm/AES_algorithm.srcs/constrs_1/new/tim.xdc
  link_design -top shift_rows -part xc7a200tfbg676-2
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force shift_rows_opt.dcp
  create_report "impl_2_opt_report_drc_0" "report_drc -file shift_rows_drc_opted.rpt -pb shift_rows_drc_opted.pb -rpx shift_rows_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force shift_rows_placed.dcp
  create_report "impl_2_place_report_io_0" "report_io -file shift_rows_io_placed.rpt"
  create_report "impl_2_place_report_utilization_0" "report_utilization -file shift_rows_utilization_placed.rpt -pb shift_rows_utilization_placed.pb"
  create_report "impl_2_place_report_control_sets_0" "report_control_sets -verbose -file shift_rows_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force shift_rows_routed.dcp
  create_report "impl_2_route_report_drc_0" "report_drc -file shift_rows_drc_routed.rpt -pb shift_rows_drc_routed.pb -rpx shift_rows_drc_routed.rpx"
  create_report "impl_2_route_report_methodology_0" "report_methodology -file shift_rows_methodology_drc_routed.rpt -pb shift_rows_methodology_drc_routed.pb -rpx shift_rows_methodology_drc_routed.rpx"
  create_report "impl_2_route_report_power_0" "report_power -file shift_rows_power_routed.rpt -pb shift_rows_power_summary_routed.pb -rpx shift_rows_power_routed.rpx"
  create_report "impl_2_route_report_route_status_0" "report_route_status -file shift_rows_route_status.rpt -pb shift_rows_route_status.pb"
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file shift_rows_timing_summary_routed.rpt -warn_on_violation  -rpx shift_rows_timing_summary_routed.rpx"
  create_report "impl_2_route_report_incremental_reuse_0" "report_incremental_reuse -file shift_rows_incremental_reuse_routed.rpt"
  create_report "impl_2_route_report_clock_utilization_0" "report_clock_utilization -file shift_rows_clock_utilization_routed.rpt"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force shift_rows_routed_error.dcp
